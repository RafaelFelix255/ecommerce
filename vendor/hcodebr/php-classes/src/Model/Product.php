...
class Product extends Model {
    ...
    public function save(){
        ...
        $results = $sql->query("CALL sp_products_save(:idproduct, :desproduct, :vlprice, :vlwidth, :vlheight, :vllength, :vlweight, :desurl)", array(
    ...
    public function checkPhoto(){
        if (file_exists($_SERVER['DOCUMENT_ROOT'].DIRECTORY_SEPARATOR."res".
            ...
            $url = "/res/site/img/no-photo2.jpg";
        }
    ...
    public function setPhoto($file){
        ...
        $dist = str_replace("/", "\\", $_SERVER['DOCUMENT_ROOT']).DIRECTORY_SEPARATOR."res".
                DIRECTORY_SEPARATOR."site".DIRECTORY_SEPARATOR."img".
    ...
    public function getFromURL($desurl){
        ...
        $rows = $sql->select("select * from tb_products a where a.desurl = :desurl limit 1;",
                          array(":desurl"=>$desurl
        ));
    ...
    public function getCategories(){
        ...
        $sql = new Sql();        
        return $sql->select("select * from tb_categories a, tb_productscategories b
