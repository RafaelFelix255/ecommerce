                                        ...
                                        <tr class="cart_item">
                                            ...
                                            <td class="product-quantity">
                                                <div class="quantity buttons_added">
                                                    <input type="button" class="minus" title="Excluir" value="-" onclick="window.location.href = '/cart/<?php echo htmlspecialchars( $value1["idproduct"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/minus'">
                                                    ...
                                                    <input type="button" class="plus" title="Adicionar" value="+" onclick="window.location.href = '/cart/<?php echo htmlspecialchars( $value1["idproduct"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/add'">
                                                </div>
                                            </td>
                            ...
                            <div class="cart-collaterals">
                                ...
                                <div class="cross-sells">
                                    ...
                                    <div class="coupon">
                                        ...
                                        <input type="text" placeholder="00000000" maxlength="8" value="<?php echo htmlspecialchars( $cart["deszipcode"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" id="cep" class="input-text" name="zipcode">
