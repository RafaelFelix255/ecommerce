  		...
  		<div class="box box-primary">
            ...
            <div class="box-body no-padding">
              <table class="table table-striped">
                <thead>
                  <tr>
                    <th style="width: 100px; text-align: center;">ID Categoria</th>
                    <th style="text-align: left;">Nome da Categoria</th>
                    <th style="width: 260px; text-align: center;">&nbsp;</th>
                  </tr>
                </thead>
                <tbody>
                  ...
                  <tr>
                    <td style="text-align: center;"><?php echo htmlspecialchars( $value1["idcategory"], ENT_COMPAT, 'UTF-8', FALSE ); ?></td>
                    <td style="text-align: left;"><?php echo htmlspecialchars( $value1["descategory"], ENT_COMPAT, 'UTF-8', FALSE ); ?></td>
