                ...
                <div class="box-tools">
                  <form action="/admin/categories">
                    <div class="input-group input-group-sm">
                      <input type="text" name="descategory" class="form-control pull-right" placeholder="Digite a categoria" value="<?php echo htmlspecialchars( $search['descategory'], ENT_COMPAT, 'UTF-8', FALSE ); ?>">
